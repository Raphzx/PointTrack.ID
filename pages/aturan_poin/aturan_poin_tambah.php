        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-6 md:p-8 border-b border-slate-100 bg-slate-50/50">
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Silakan isi form di bawah ini untuk menambahkan aturan poin baru.
                </p>
            </div>

            <form action="aturan_poin_tambah_proses" method="POST" class="p-6 md:p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-bold text-slate-700">Minimal Poin <span class="text-rose-500">*</span></label>
                        <input type="number" name="min_poin" required
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="max_poin" required
                               class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white outline-none transition-all text-slate-700 font-medium"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="tindakan" required
                           class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white outline-none transition-all text-slate-700 font-medium"
                           placeholder="Contoh: Aman, Panggilan Siswa, dll">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <select name="warna" required
                        ...
                        <option value="emerald" class="text-emerald-600 font-bold">Emerald (Hijau)</option>
                        <option value="yellow" class="text-yellow-600 font-bold">Yellow (Kuning)</option>
                        <option value="orange" class="text-orange-600 font-bold">Orange (Oranye)</option>
                        <option value="rose" class="text-rose-600 font-bold">Rose (Merah)</option>
                        <option value="slate" class="text-slate-700 font-bold">Slate (Abu-abu)</option>
                    </select>
                </div>
