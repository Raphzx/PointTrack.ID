    ...
    <div class="bg-white rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-100 overflow-hidden max-w-2xl mx-auto">
        ...
        <div class="p-8 border-b border-slate-50 bg-slate-50/50">
            <div class="flex items-center gap-4">
                <div class="h-12 w-12 rounded-2xl bg-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                    </svg>
                </div>
                <div>
                    <h2 class="text-xl font-bold text-slate-800 tracking-tight">Tambah Pengguna Baru</h2>
                    <p class="text-sm text-slate-500">Tambahkan Pengguna baru ke dalam sistem.</p>
                </div>
            </div>
        </div>

        <form action="index.php?page=users_tambah_proses" method="POST" class="p-8 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative group">
                    ...
                    <input type="password" name="password" placeholder="••••••••" 
                           class="w-full rounded-2xl border border-slate-200 pl-11 pr-4 py-3 text-sm focus:ring-4 focus:ring-blue-100 focus:border-blue-400 focus:outline-none transition-all duration-300" required />
                </div>
            </div>
    ...
    <div class="space-y-2">
        ...
        <div class="relative group">
            ...
            <select name="role" 
                ...
                <option value="guru" class="py-2">Guru</option>
            </select>
    ...
    <div class="space-y-2">
        ...
        <div class="relative group">
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-50">
                ...
                <button type="submit" 
                        class="px-8 py-3 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold transition-all duration-300 shadow-lg shadow-blue-200 hover:-translate-y-1 active:scale-95">
                    Simpan Pengguna
                </button>
            </div>
        </form>
